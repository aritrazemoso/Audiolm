...
from .buffer_stategy.buffer_stategy_factory import BufferingStrategyFactory
...
class Client:
    ...
    def __init__(self, client_id: str, sampling_rate: int, samples_width: int):
        ...
        self.config = {
            ...
            "processing_args": {
                "chunk_length_seconds": 0.4,
                "chunk_offset_seconds": 0.01,
            },
        }
        self.file_counter = 0
    ...
    async def process_audio(
        self, websocket, vad_pipeline, asr_pipeline, transcriptions_list: list
    ):
        return await self.buffering_strategy.process_audio(
